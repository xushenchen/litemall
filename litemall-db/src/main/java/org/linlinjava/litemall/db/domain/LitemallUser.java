...
public class LitemallUser {
     ...
     * 用户下单折扣
     */
    private BigDecimal userOrderDiscount;
    ...
    public BigDecimal getUserOrderDiscount() {
        if (this.userOrderDiscount == null)
            return  new BigDecimal(0);
        return userOrderDiscount;
    }

    public void setUserOrderDiscount(BigDecimal userOrderDiscount) {
        if (userOrderDiscount == null || userOrderDiscount.doubleValue() < 0 || userOrderDiscount.doubleValue() > 10) {
            this.userOrderDiscount = new BigDecimal(0);
        } else {
            this.userOrderDiscount = userOrderDiscount;
        }
    }
